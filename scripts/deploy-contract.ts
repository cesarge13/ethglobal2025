 ...
 * 
 * IMPORTANTE: Este script despliega en MAINNET. Asegúrate de tener:
 * 1. MATIC suficiente para gas
 * 2. PRIVATE_KEY configurada en .env
 * 3. POLYGON_RPC_URL apuntando a mainnet
 * 
 * Uso: npx hardhat run scripts/deploy-contract.ts --network polygon
 */
async function main() {
  ...
  console.log("\n📋 Próximos pasos:");
  console.log("1. Guarda la dirección del contrato en tu archivo .env");
  console.log("2. Configura el backend para usar esta dirección");
  console.log("3. Configura el agente IA con esta dirección");
}
